...
<div id="page-wrapper" >
    <div id="page-inner">
         <div class="row">
               <div class="col-md-12">
<br/>
<h1>Total de faturamento R$:{{$consulta}}</h1>
<br/>
<h1>Agendamentos Gerados nesse periodo de tempo:</h1>
...
<center>{{ $agendamento->appends(["data" => $_REQUEST['data'], "data2" => $_REQUEST['data2']])->links() }}</center>
</div>
</div>
</div>
