...
<center><h1>Agendamentos de ontem</h1></center><br/>
<h1><center>{{Carbon\Carbon::parse($ontem)->format('d-m-Y')}}</h1></center><br/>
...
<div id="calendario">
  ...
  @endforeach
  @empty
  <div class="alert alert-danger" role="alert"><center>Nada agendado ontem</center></div>
  @endforelse
  <br/>
