...
<h2 class="text-center">Cadastro de nova marca de fornecedor</h2>
<br/>
<a class="btn btn-info" href="listar_marca_fornecedor">Listar Marcas de fornecedores cadastradas</a>
<br/>
<br/>
@if($errors->has())
<div>
...
<form action="{{url('cadastrando_marca_fornecedor')}}" method="post">
	Marca do produto:<input  value="{{old('marca_fornecedor')}}"class="form-control" type="text" name="marca_fornecedor">
	<br/>
	<br/>
